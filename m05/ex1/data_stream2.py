...
class StreamProcessor:
    ...
    def process_streams(self, batches: Dict[str, List[Any]], criteria: Optional[str] = None) -> None:
        for stream in self.streams:
            try:
                ...
                print(f"Stream ID: [{stream.stream_id}] {result}")
...
def main() -> None:
    ...
    mixed_batches = {
        "sensor_1": [{"temperature": 22.5}, {"humidity": 21.8}, {"pressure": 23.1}],
        "tx_1": [
